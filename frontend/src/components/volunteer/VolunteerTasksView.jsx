        ...
        return (
          ...
          >
            ...
            <div className="flex justify-end gap-2">
              {isCompleted ? (
                <span className="px-4 py-2 font-semibold text-base text-green-700 dark:text-green-400" role="status">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-green-600 text-white font-semibold text-base hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-600/40 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
                >
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl border-2 border-[#c84444] text-[#c84444] font-semibold text-base hover:bg-red-50 dark:hover:bg-red-900/20 focus:outline-none focus:ring-2 focus:ring-[#c84444]/40 disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
              >
