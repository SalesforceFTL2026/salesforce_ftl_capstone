      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#e8e8e8] dark:bg-[#273A20] rounded-[2rem] p-8 flex flex-col transition-colors duration-300">
            <h3 className="text-3xl font-bold text-black dark:text-white mb-6 transition-colors duration-300">{t('landing.whatWeDo.title')}</h3>
            ...
            <div className="bg-[#d4d4d4] dark:bg-[#1a2332] rounded-2xl h-56 mb-6 flex items-center justify-center transition-colors duration-300">
              <span className="text-gray-600 dark:text-gray-400 text-sm transition-colors duration-300">{t('landing.whatWeDo.graphic')}</span>
            </div>
