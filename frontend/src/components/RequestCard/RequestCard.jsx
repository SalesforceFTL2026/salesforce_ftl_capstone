        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {onEdit && (
            <button
              ...
              className="p-1.5 rounded-lg text-gray-500 hover:text-[#6ba3d3] hover:bg-blue-50 dark:hover:bg-blue-900/30 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
          ...
          {onDelete && (
            <button
              ...
              className="p-1.5 rounded-lg text-gray-500 hover:text-[#c84444] hover:bg-red-50 dark:hover:bg-red-900/30 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
